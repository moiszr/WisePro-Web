...
function sidebarType(a) {
  ...
  if ((color == 'bg-white') && bodyWhite) {
    ...
    var navbarBrandImg = navbarBrand.src;
      ...
      if (navbarBrandImg.includes('Logo-W.png')) {
          var navbarBrandImgNew = navbarBrandImg.replace("Logo-W", "Logo-D");
      navbarBrand.src = navbarBrandImgNew;
    }
  } else {
    var navbarBrand = document.querySelector('.navbar-brand-img');
    var navbarBrandImg = navbarBrand.src;
      if (navbarBrandImg.includes('Logo-D.png')) {
          var navbarBrandImgNew = navbarBrandImg.replace("Logo-D", "Logo-W");
      navbarBrand.src = navbarBrandImgNew;
    }
  }
